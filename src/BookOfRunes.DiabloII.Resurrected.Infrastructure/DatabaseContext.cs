...
namespace BookOfRunes.DiabloII.Resurrected.Infrastructure
{
	public class DatabaseContext : DbContext
	{
		...
		public DbSet<UserRuneEntity> UserRunes { get; set; }
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<UserEntity>()
				.Build(_schema);
			modelBuilder.Entity<UserRuneEntity>()
				.Build(_schema);
	...
	internal static class DatabaseContextExtensions
	{
		...
		public static void Build(this EntityTypeBuilder<UserEntity> builder, string schema)
		{
			builder.ToTable("users", schema: schema)
				.HasKey(e => e.Id);

			builder.Property(e => e.Id)
				.HasColumnName("id");
		}
		public static void Build(this EntityTypeBuilder<UserRuneEntity> builder, string schema)
		{
			builder.ToTable("user_runes", schema: schema)
				.HasKey(e => e.Id);
			...
			builder.HasOne(r => r.User)
				...
				.HasConstraintName("FK_users_user_runes")
				.IsRequired();

			builder.HasOne(r => r.Rune)
				.WithMany()
				.HasForeignKey("id_rune")
				.HasConstraintName("FK_runes_user_runes")
				.IsRequired();
		}
		public static void Build(this EntityTypeBuilder<CharacterEntity> builder, string schema)
		{
			builder.ToTable("characters", schema: schema)
				.HasKey(e => e.Id);
			...
			builder.HasOne(r => r.User)
				.WithMany()
				.HasForeignKey("id_user")
				.HasConstraintName("FK_users_characters")
				.IsRequired();
	...
	public class DatabaseContextFactory : IDesignTimeDbContextFactory<DatabaseContext>
	{
		public DatabaseContext CreateDbContext(string[] args)
		{
			...
			optionsBuilder.UseNpgsql("Host=mihben.site;Username=admin;Password=admin;Database=bookofrunes-migration");
