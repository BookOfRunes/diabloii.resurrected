...
namespace RuneDex.DiabloII.Resurrected.Test.Unit.WASM.Services
{
	public class RuneServiceTest
	{
		...
		private RuneService CreateSUT()
		{
			_senderMock = new Mock<IRequestSender>();
			_storageMock = new Mock<ILocalStorageService>();

			return new RuneService(_senderMock.Object, _storageMock.Object);
		}
	...
	{
		public static IEnumerable<GetRunesQuery.Rune> AsResponse(this IEnumerable<Rune> runes)
		{
